        ...
        Public Function FindObatById(ByVal Id As Integer) As List(Of Obat)
            ...
            Try
                ...
                While rdr.Read()
                    ...
                    x.IdObat = rdr("id_obat").ToString()
                    x.NamaObat = rdr("nama_obat").ToString()
                    x.Kode_obat = rdr("kode_obat").ToString()
                    x.Barcode_obat = rdr("barcode_obat").ToString()
                    x.Id_jenis_obat = rdr("id_jenis_obat").ToString()
                    x.Id_golongan = rdr("id_golongan").ToString()
                    x.Id_sub_golongan = rdr("id_sub_golongan").ToString()
                    x.Id_merk = rdr("id_merk").ToString()
                    ...
                    x.IdMember = rdr("id_member").ToString()
