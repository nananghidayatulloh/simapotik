Public Class frmSubGolObat
    Dim DtDataview As New DataView
    Dim objDataTable As New DataTable
    Dim bMgr As BindingManagerBase
    Dim GolonganObatBindSource As New BindingSource

    Private Sub frmGolonganObat_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Public Sub ListViewDesign()
        ...
        ListView1.Columns.Add("Nama Golongan Obat", 200, HorizontalAlignment.Center)
    End Sub

    Public Sub FillListview()
        Try
            Dim DataControl As New AccessData.DataControl
            Dim myData As DataSet = DataControl.GetDataSet("Select * from tbl_Golongan")
            ...
            For i = 0 To (objDataTable.Rows.Count - 1)
                With objDataTable.Rows(i)
                    ...
                    lSingleItem = ListView1.Items.Add(.Item("id_Golongan").ToString)
                    lSingleItem.SubItems.Add(.Item("nama_Golongan").ToString)
                End With
            Next i
    ...
    Private Sub frmSubGolObat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ListViewDesign()
        FillListview()
    End Sub
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        Try
            Dim DataControl As New AccessData.DataControl
            Dim myData As DataSet = DataControl.GetDataSet("Select * from tbl_Golongan where nama_Golongan like '" & txtSearch.Text & "%'")
            objDataTable = myData.Tables("data")
            DtDataview.Table = objDataTable
            ListView1.Items.Clear()
            For i = 0 To (objDataTable.Rows.Count - 1)
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        frmMstSubGolObat.Data = CInt(ListView1.Items(x).SubItems(0).Text)
        frmMstSubGolObat.Opt = 2
        frmMstSubGolObat.ShowDialog()
    End Sub
    ...
    Private Sub HapusToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles HapusToolStripMenuItem.Click
        ...
        If MsgBox("Anda yakin ingin menghapus data : " & ListView1.Items(x).SubItems(1).Text & "?", MsgBoxStyle.Information Or MsgBoxStyle.YesNo, "Konfirmasi") = MsgBoxResult.Yes Then
            Try
                ...
                SubGolonganObat.IdGolongan = CInt(ListView1.Items(x).SubItems(0).Text)
                AccessSubGolonganObat.GolonganObatDelete(SubGolonganObat.IdGolongan)
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        End If
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        If ListView1.SelectedItems.Count > 0 Then
            ...
            If MsgBox("Anda yakin ingin menghapus data :  " & ListView1.Items(x).SubItems(1).Text & "?", MsgBoxStyle.Information Or MsgBoxStyle.YesNo, "Konfirmasi") = MsgBoxResult.Yes Then
                Try
                    Dim SubGolonganObat As New SubGolonganObat
                    Dim AccessGolonganObat As New AccessData.AccessSubGolonganObat
                    SubGolonganObat.IdGolongan = CInt(ListView1.Items(x).SubItems(0).Text)
                    AccessGolonganObat.GolonganObatDelete(SubGolonganObat.IdGolongan)
                Catch ex As Exception
                    MsgBox(ex.Message)
                End Try
            End If
