Public Class frmSatuan
    ...
    Private Sub frmSatuan_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Public Sub ListViewDesign()
        ...
        ListView1.Columns.Add("Nama Satuan", 500, HorizontalAlignment.Center)
    End Sub

    Public Sub FillListview()
        Try
            Dim DataControl As New AccessData.DataControl
            Dim myData As DataSet = DataControl.GetDataSet("Select * from tbl_Satuan")
            ...
            For i = 0 To (objDataTable.Rows.Count - 1)
                With objDataTable.Rows(i)
                    ...
                    lSingleItem = ListView1.Items.Add(.Item("id_Satuan").ToString)
                    lSingleItem.SubItems.Add(.Item("nama_Satuan").ToString)
                End With
            Next i
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        Try
            Dim DataControl As New AccessData.DataControl
            Dim myData As DataSet = DataControl.GetDataSet("Select * from tbl_Satuan where nama_Satuan like '" & txtSearch.Text & "%'")
            objDataTable = myData.Tables("data")
            DtDataview.Table = objDataTable
            ListView1.Items.Clear()
            For i = 0 To (objDataTable.Rows.Count - 1)
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        frmMstSatuan.Data = CInt(ListView1.Items(x).SubItems(0).Text)
        frmMstSatuan.Opt = 2
        frmMstSatuan.ShowDialog()
    End Sub
    ...
    Private Sub HapusToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles HapusToolStripMenuItem.Click
        ...
        If MsgBox("Anda yakin ingin menghapus data : " & ListView1.Items(x).SubItems(1).Text & "?", MsgBoxStyle.Information Or MsgBoxStyle.YesNo, "Konfirmasi") = MsgBoxResult.Yes Then
            Try
                ...
                Satuan.IdSatuan = CInt(ListView1.Items(x).SubItems(0).Text)
                AccessSatuan.SatuanDelete(Satuan.IdSatuan)
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        End If
