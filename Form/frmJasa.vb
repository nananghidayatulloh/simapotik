        ...
        Try
            ...
            For i = 0 To (objDataTable.Rows.Count - 1)
                With objDataTable.Rows(i)
                    ...
                    lSingleItem.SubItems.Add(Format(.Item("harga_netto"), "###,###").ToString)
                    lSingleItem.SubItems.Add(Format(.Item("harga_non_resep"), "###,###").ToString)
                    lSingleItem.SubItems.Add(Format(.Item("harga_resep"), "###,###").ToString)
                    lSingleItem.SubItems.Add(Format(.Item("harga_bpjs"), "###,###").ToString)
                    lSingleItem.SubItems.Add(Format(.Item("harga_khusus"), "###,###").ToString)
