Public Class frmGudang
    ...
    Private Sub frmGudang_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Public Sub ListViewDesign()
        ...
        ListView1.Columns.Add("Nama Gudang", 500, HorizontalAlignment.Center)
    End Sub
        ...
        Try
            ...
            For i = 0 To (objDataTable.Rows.Count - 1)
                With objDataTable.Rows(i)
                    ...
                    lSingleItem = ListView1.Items.Add(.Item("id_Gudang").ToString)
    ...
    Private Sub frmGudang_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ListViewDesign()
        FillListview()
    End Sub
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        Try
            Dim DataControl As New AccessData.DataControl
            Dim myData As DataSet = DataControl.GetDataSet("Select * from tbl_Gudang where nama_Gudang like '" & txtSearch.Text & "%'")
            objDataTable = myData.Tables("data")
            DtDataview.Table = objDataTable
            ListView1.Items.Clear()
            For i = 0 To (objDataTable.Rows.Count - 1)
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        frmMstGudang.Data = CInt(ListView1.Items(x).SubItems(0).Text)
        frmMstGudang.Opt = 2
        frmMstGudang.ShowDialog()
    End Sub
    ...
    Private Sub HapusToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles HapusToolStripMenuItem.Click
        ...
        If MsgBox("Anda yakin ingin menghapus data : " & ListView1.Items(x).SubItems(1).Text & "?", MsgBoxStyle.Information Or MsgBoxStyle.YesNo, "Konfirmasi") = MsgBoxResult.Yes Then
            Try
                ...
                Gudang.IdGudang = CInt(ListView1.Items(x).SubItems(0).Text)
                AccessGudang.GudangDelete(Gudang.IdGudang)
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        End If
